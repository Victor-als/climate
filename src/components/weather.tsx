...
export function Weather ({currentWeather, weatherData}: IWeatherProps){
  ...
  return (
    ...
    <div className="fixed top-36 left-20 p-4 text-white">
      <div className="absolute w-32 h-16 blur-md top-28 left-[10rem] rounded-full shadow-2xl shadow-blue-800/100 bg-blue-600"></div>

      {currentWeather && (
        <div
          className="flex flex-col shadow-shape items-start justify-center 
      ...
      {weatherData && (
        <div className="mt-8">
          ...
          <div
            ...
            bg-opacity-10 w-full shadow-shape rounded-3xl text-zinc-50 pt-4 px-4"
          >
    ...
    {/* Weather Details Section: Normal Scroll */}
    <div className="ml-[20rem] mt-36">
